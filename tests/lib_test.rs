...
fn test_sr1_succeeds() {
    ...
    assert_ne!(sr1(1i128), 2i128);
    assert_ne!(sr1(2i128), 3i128);
    assert_ne!(sr1(3i128), 6i128);
}
...
fn test_sr2_succeeds() {
    ...
    assert_ne!(sr2(1i128), 2i128);
    assert_ne!(sr2(2i128), 3i128);
    assert_ne!(sr2(3i128), 6i128);
}
...
fn test_sr3_succeeds() {
    ...
    assert_ne!(sr3(1i128), 2i128);
    assert_ne!(sr3(2i128), 3i128);
    assert_ne!(sr3(3i128), 6i128);
}
